...
const transformItem = item => {
  return {
    ...item,
    start_time: format.formatCommonTime(item.start_time),
    end_time: format.formatCommonTime(item.end_time),
    end_join_time: format.formatCommonTime(item.end_join_time),
